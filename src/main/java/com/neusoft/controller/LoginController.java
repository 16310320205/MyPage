...
public class LoginController {
	...
	public String reg(Model model, @RequestParam("username") String username, @RequestParam("email") String email,
		...
		try {
			...
			if (map.containsKey("ticket")) {
				...
				eventProducer.fireEvent(
						new EventModel(EventType.Regist).setExt("username", username).setExt("email", email));
