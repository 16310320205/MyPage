...
public class FollowService {
	...
	public List<Integer> getFollowers(int entityType, int entityId, Integer offset, int count) {
		String followerKey = RedisKeyUtil.getFollowerKey(entityType, entityId);
	...
	public List<Integer> getFollowees(int entityType, int entityId, Integer offset, int count) {
		String followeeKey = RedisKeyUtil.getFolloweeKey(entityType, entityId);
